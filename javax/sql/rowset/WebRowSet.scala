...
trait WebRowSet extends CachedRowSet {
    ...
    // to the given OutputStream object in XML format.
    def writeXml(rs: ResultSet, oStream: OutputStream): Unit = ???
