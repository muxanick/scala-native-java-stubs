...
abstract class IIOMetadata extends Object {
    ...
    // is called.
    protected def controller: IIOMetadataController

    // An IIOMetadataController that is suggested for use
    // as the controller for this IIOMetadata object.
    protected def defaultController: IIOMetadataController
    ...
    protected def extraMetadataFormatClassNames: Array[String]

    // An array of names of formats, other than the standard and
    // native formats, that are supported by this plug-in,
    // initialized to null and set via the constructor.
    protected def extraMetadataFormatNames: Array[String]
    ...
    protected def nativeMetadataFormatClassName: String

    // The name of the native metadata format for this object,
    // initialized to null and set via the constructor.
    protected def nativeMetadataFormatName: String
