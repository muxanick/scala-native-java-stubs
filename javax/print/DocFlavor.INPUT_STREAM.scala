...
object DocFlavor.INPUT_STREAM extends DocFlavor {
     ...
     */
    @stub
    val AUTOSENSE: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val GIF: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val JPEG: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val PCL: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val PDF: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val PNG: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val POSTSCRIPT: DocFlavor.INPUT_STREAM = ???

    /** Doc flavor with MIME type = "text/html",
     *  encoded in the host platform encoding.
     */
    @stub
    val TEXT_HTML_HOST: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_HTML_US_ASCII: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_16: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_16BE: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_16LE: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_8: DocFlavor.INPUT_STREAM = ???

    /** Doc flavor with MIME type = "text/plain",
     *  encoded in the host platform encoding.
     */
    @stub
    val TEXT_PLAIN_HOST: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_PLAIN_US_ASCII: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_PLAIN_UTF_16: DocFlavor.INPUT_STREAM = ???
     ...
     */
    @stub
    val TEXT_PLAIN_UTF_16BE: DocFlavor.INPUT_STREAM = ???
