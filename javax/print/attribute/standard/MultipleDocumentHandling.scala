...
object MultipleDocumentHandling {
    ...
    // further information.
    def SEPARATE_DOCUMENTS_COLLATED_COPIES: MultipleDocumentHandling = ???

    @stub
    // Separate documents uncollated copies -- see above for
    // further information.
    def SEPARATE_DOCUMENTS_UNCOLLATED_COPIES: MultipleDocumentHandling = ???

    @stub
    // Single document -- see above for further
    // information.
    def SINGLE_DOCUMENT: MultipleDocumentHandling = ???
}
