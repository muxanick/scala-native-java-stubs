...
object Finishings {
    ...
    def COVER: Finishings = ???

    @stub
    // Bind the document(s) with one or more staples (wire stitches) along one
    // edge.
    def EDGE_STITCH: Finishings = ???

    @stub
    // Bind the document(s) with one or more staples (wire stitches) along the
    // bottom edge.
    def EDGE_STITCH_BOTTOM: Finishings = ???

    @stub
    // Bind the document(s) with one or more staples (wire stitches) along the
    // left edge.
    def EDGE_STITCH_LEFT: Finishings = ???

    @stub
    // Bind the document(s) with one or more staples (wire stitches) along the
    // right edge.
    def EDGE_STITCH_RIGHT: Finishings = ???

    @stub
    // Bind the document(s) with one or more staples (wire stitches) along the
    // top edge.
    def EDGE_STITCH_TOP: Finishings = ???
