...
object DocFlavor_BYTE_ARRAY extends DocFlavor {
     ...
     */
    @stub
    val POSTSCRIPT: DocFlavor.BYTE_ARRAY = ???

    /** Doc flavor with MIME type = "text/html",
     *  encoded in the host platform encoding.
     */
    @stub
    val TEXT_HTML_HOST: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_HTML_US_ASCII: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_16: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_16BE: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_16LE: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_HTML_UTF_8: DocFlavor.BYTE_ARRAY = ???

    /** Doc flavor with MIME type = "text/plain",
     *  encoded in the host platform encoding.
     */
    @stub
    val TEXT_PLAIN_HOST: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_PLAIN_US_ASCII: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_PLAIN_UTF_16: DocFlavor.BYTE_ARRAY = ???
     ...
     */
    @stub
    val TEXT_PLAIN_UTF_16BE: DocFlavor.BYTE_ARRAY = ???
