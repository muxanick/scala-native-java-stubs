...
abstract class AbstractButton extends JComponent with ItemSelectable, with SwingConstants {
    ...
    protected def AbstractButton.AccessibleAbstractButton: class

    // The button model's ActionListener.
    protected def actionListener: ActionListener
    ...
    protected def model: ButtonModel
...
object AbstractButton {
    ...
    def BORDER_PAINTED_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to having the button paint the content area.
    def CONTENT_AREA_FILLED_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon used when the button has
    // been disabled.
    def DISABLED_ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon used when the button has been
    // disabled and selected.
    def DISABLED_SELECTED_ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to having the border highlighted when focused,
    // or not.
    def FOCUS_PAINTED_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change in the button's horizontal alignment.
    def HORIZONTAL_ALIGNMENT_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change in the button's horizontal text position.
    def HORIZONTAL_TEXT_POSITION_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon that represents the button.
    def ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change in the button's margins.
    def MARGIN_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the button's mnemonic.
    def MNEMONIC_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change in the button model.
    def MODEL_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon used when the button has been
    // pressed.
    def PRESSED_ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change from rollover enabled to disabled or back
    // to enabled.
    def ROLLOVER_ENABLED_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon used when the cursor is over
    // the button.
    def ROLLOVER_ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon used when the cursor is
    // over the button and it has been selected.
    def ROLLOVER_SELECTED_ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change to the icon used when the button has
    // been selected.
    def SELECTED_ICON_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change in the button's text.
    def TEXT_CHANGED_PROPERTY: String = ???

    @stub
    // Identifies a change in the button's vertical alignment.
    def VERTICAL_ALIGNMENT_CHANGED_PROPERTY: String = ???
}
