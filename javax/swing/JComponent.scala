...
import java.awt.{AWTKeyStroke, Color, Component, Component.AccessibleAWTComponent, Component.BaselineResizeBehavior, Container, Container.AccessibleAWTContainer, Dimension, Font, FontMetrics, Graphics, Insets, Point, Rectangle}
import java.awt.event.{ActionListener, ContainerEvent, ContainerListener, FocusEvent, FocusListener, KeyEvent, MouseEvent}
...
abstract class JComponent extends Container with Serializable {
     ...
     *  Please see XMLEncoder.
     */
    abstract class AccessibleJComponent extends Container.AccessibleAWTContainer with AccessibleExtendedComponent {
         ...
         */
        protected class AccessibleFocusHandler extends Object with FocusListener {
