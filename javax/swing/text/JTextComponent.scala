...
import javax.accessibility.{Accessible, AccessibleAction, AccessibleContext, AccessibleEditableText, AccessibleExtendedText, AccessibleRole, AccessibleStateSet, AccessibleText, AccessibleTextSequence}
import javax.print.PrintService
import javax.print.attribute.PrintRequestAttributeSet
import javax.swing.{Action, DropMode, JComponent, JComponent.AccessibleJComponent, KeyStroke, Scrollable, TransferHandler.DropLocation}
...
abstract class JTextComponent extends JComponent with Scrollable with Accessible {
     ...
     *  Please see XMLEncoder.
     */
    class AccessibleJTextComponent extends JComponent.AccessibleJComponent with AccessibleText with CaretListener with DocumentListener with AccessibleAction with AccessibleEditableText with AccessibleExtendedText {
...
object JTextComponent {
     ...
     *  Please see XMLEncoder.
     */
    object KeyBinding extends Object {

        /** Creates a new key binding. */
        @stub
        def apply(key: KeyStroke, actionName: String) = ???
