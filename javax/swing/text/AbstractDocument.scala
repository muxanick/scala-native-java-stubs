...
abstract class AbstractDocument extends Object with Document, with Serializable {
    ...
    def AbstractDocument.AbstractElement: class

    // Implements a composite element that contains other elements.
    def AbstractDocument.BranchElement: class

    // Stores document changes as the document is being
    // modified.
    def AbstractDocument.DefaultDocumentEvent: class
...
object AbstractDocument {
    ...
    // techniques.
    def AbstractDocument.AttributeContext: trait = ???

    @stub
    // Interface to describe a sequence of character content that
    // can be edited.
    def AbstractDocument.Content: trait = ???

    @stub
    // An implementation of ElementChange that can be added to the document
    // event.
    def AbstractDocument.ElementEdit: class = ???

    @stub
    // Error message to indicate a bad location.
    protected def BAD_LOCATION: String = ???

    @stub
    // Name of elements used to hold a unidirectional run
    def BidiElementName: String = ???

    @stub
    // Name of elements used to represent content
    def ContentElementName: String = ???

    @stub
    // Name of the attribute used to specify element
    // names.
    def ElementNameAttribute: String = ???

    @stub
    // Name of elements used to represent paragraphs
    def ParagraphElementName: String = ???
}
