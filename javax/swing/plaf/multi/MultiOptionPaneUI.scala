...
class MultiOptionPaneUI extends OptionPaneUI {
    ...
    def containsCustomComponents(a: JOptionPane): Boolean = ???
    ...
    def selectInitialValue(a: JOptionPane): Unit = ???
