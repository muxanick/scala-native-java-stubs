...
/**  */
object BasicBorders_ButtonBorder extends AbstractBorder with UIResource {

    /**  */
    @stub
    def ButtonBorder(shadow: Color, darkShadow: Color, highlight: Color, lightHighlight: Color) = ???
