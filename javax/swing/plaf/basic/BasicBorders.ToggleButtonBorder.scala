...
/**  */
object BasicBorders.ToggleButtonBorder extends BasicBorders.ButtonBorder {

    /**  */
    @stub
    def ToggleButtonBorder(shadow: Color, darkShadow: Color, highlight: Color, lightHighlight: Color) = ???
