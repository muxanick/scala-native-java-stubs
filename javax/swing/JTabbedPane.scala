...
import java.awt.{Color, Component, Component.AccessibleAWTComponent, Container, Container.AccessibleAWTContainer, Point, Rectangle}
...
class JTabbedPane extends JComponent with Serializable with Accessible with SwingConstants {
     ...
     *  Please see XMLEncoder.
     */
    protected class AccessibleJTabbedPane extends JComponent.AccessibleJComponent with AccessibleSelection with ChangeListener {
     ...
     */
    protected class ModelListener extends Object with ChangeListener with Serializable {
