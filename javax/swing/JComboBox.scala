...
import java.awt.{Component, Component.AccessibleAWTComponent, Container, Container.AccessibleAWTContainer, ItemSelectable}
...
class JComboBox[E] extends JComponent with ItemSelectable with ListDataListener with ActionListener with Accessible {
     ...
     *  Please see XMLEncoder.
     */
    protected class AccessibleJComboBox extends JComponent.AccessibleJComponent with AccessibleAction with AccessibleSelection {
