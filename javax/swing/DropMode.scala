...
object DropMode {
     ...
     */
    final val INSERT: DropMode = new DropMode("INSERT", 0)
     ...
     *  data.
     */
    final val INSERT_COLS: DropMode = new DropMode("INSERT_COLS", 1)
     ...
     *  data.
     */
    final val INSERT_ROWS: DropMode = new DropMode("INSERT_ROWS", 2)

    /** The drop location should be tracked in terms of the index of
     *  existing items.
     */
    final val ON: DropMode = new DropMode("ON", 3)
     ...
     */
    final val ON_OR_INSERT: DropMode = new DropMode("ON_OR_INSERT", 4)
     ...
     */
    final val ON_OR_INSERT_COLS: DropMode = new DropMode("ON_OR_INSERT_COLS", 5)
     ...
     */
    final val ON_OR_INSERT_ROWS: DropMode = new DropMode("ON_OR_INSERT_ROWS", 6)

    /** A component's own internal selection mechanism (or caret for text
     *  components) should be used to track the drop location.
     */
    final val USE_SELECTION: DropMode = new DropMode("USE_SELECTION", 7)
