...
class AudioFormat extends Object {
    ...
    protected def bigEndian: Boolean = ???

    @stub
    // The number of audio channels in this format (1 for mono, 2 for stereo).
    protected def channels: Int = ???

    @stub
    // The audio encoding technique used by this format.
    protected def encoding: AudioFormat.Encoding = ???

    @stub
    // The number of frames played or recorded per second, for sounds that have this format.
    protected def frameRate: float = ???

    @stub
    // The number of bytes in each frame of a sound that has this format.
    protected def frameSize: Int = ???

    @stub
    // The number of samples played or recorded per second, for sounds that have this format.
    protected def sampleRate: float = ???
