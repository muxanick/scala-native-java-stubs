...
abstract class AtomicLongFieldUpdater[T] extends Object {
     ...
     */
    def accumulateAndGet(obj: T, x: Long, accumulatorFunction: LongBinaryOperator): Long
     ...
     */
    def getAndAccumulate(obj: T, x: Long, accumulatorFunction: LongBinaryOperator): Long
     ...
     */
    def getAndSet(obj: T, newValue: Long): Long

    /** Atomically updates the field of the given object managed by this updater
     *  with the results of applying the given function, returning the previous
     *  value.
     */
    def getAndUpdate(obj: T, updateFunction: LongUnaryOperator): Long
     ...
     */
    def lazySet(obj: T, newValue: Long): Unit

    /** Sets the field of the given object managed by this updater to the
     *  given updated value.
     */
    def set(obj: T, newValue: Long): Unit
...
object AtomicLongFieldUpdater {
    ...
    @stub
    def newUpdater[U](tclass: Class[U], fieldName: String): AtomicLongFieldUpdater[U] = ???
}
