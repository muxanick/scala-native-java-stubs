 ...
 */
final class AccessController extends Object {
}
...
object AccessController {
     ...
     */
    @stub
    def doPrivileged[T](action: PrivilegedAction[T], context: AccessControlContext): T = ???
     ...
     */
    @stub
    def doPrivileged[T](action: PrivilegedAction[T], context: AccessControlContext, perms: Permission*): T = ???
     ...
     */
    @stub
    def doPrivileged[T](action: PrivilegedExceptionAction[T], context: AccessControlContext): T = ???
     ...
     */
    @stub
    def doPrivileged[T](action: PrivilegedExceptionAction[T], context: AccessControlContext, perms: Permission*): T = ???

    /** Performs the specified PrivilegedAction with privileges
     *  enabled.
     */
    @stub
    def doPrivilegedWithCombiner[T](action: PrivilegedAction[T]): T = ???
     ...
     */
    @stub
    def doPrivilegedWithCombiner[T](action: PrivilegedAction[T], context: AccessControlContext, perms: Permission*): T = ???

    /** Performs the specified PrivilegedExceptionAction with
     *  privileges enabled.
     */
    @stub
    def doPrivilegedWithCombiner[T](action: PrivilegedExceptionAction[T]): T = ???
