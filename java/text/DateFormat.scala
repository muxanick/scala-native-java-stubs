...
object DateFormat {
    ...
    object Field extends Format.Field {
        ...
        /** Creates a Field. */
        @stub
        protected def apply(name: String, calendarField: Int) = ???
        ...
        @stub
        val DAY_OF_MONTH: Field = ???

        /** Constant identifying the day of week field. */
        @stub
        val DAY_OF_WEEK: Field = ???

        /** Constant identifying the day of week field. */
        @stub
        val DAY_OF_WEEK_IN_MONTH: Field = ???

        /** Constant identifying the day of year field. */
        @stub
        val DAY_OF_YEAR: Field = ???
         ...
         */
        @stub
        val HOUR_OF_DAY0: Field = ???

        /** Constant identifying the hour of day field, where the legal values
         *  are 1 to 24.
         */
        @stub
        val HOUR_OF_DAY1: Field = ???
        ...
        @stub
        val WEEK_OF_MONTH: Field = ???

        /** Constant identifying the week of year field. */
        @stub
        val WEEK_OF_YEAR: Field = ???
