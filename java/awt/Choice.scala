...
import javax.accessibility.{Accessible, AccessibleAction, AccessibleContext, AccessibleRole}
...
class Choice extends Component with ItemSelectable with Accessible {
     ...
     */
    protected class AccessibleAWTChoice extends Component.AccessibleAWTComponent with AccessibleAction {
