...
class GridBagLayout extends Object with LayoutManager2, with Serializable {
    ...
    def columnWeights: Array[double] = ???
    ...
    protected def comptable: Hashtable[Component, GridBagConstraints] = ???
    ...
    protected def defaultConstraints: GridBagConstraints = ???

    @stub
    // This field holds the layout information
    // for the gridbag.
    protected def layoutInfo: GridBagLayoutInfo = ???

    @stub
    // This field holds the overrides to the row minimum
    // heights.
    def rowHeights: Array[Int] = ???
...
object GridBagLayout {
    ...
    protected def PREFERREDSIZE: Int = ???
}
