...
object CubicCurve2D {
     ...
     *  double coordinates.
     */
    object Double extends CubicCurve2D with Serializable {
         ...
         */
        @stub
        def apply(x1: Double, y1: Double, ctrlx1: Double, ctrly1: Double, ctrlx2: Double, ctrly2: Double, x2: Double, y2: Double) = ???
     ...
     *  float coordinates.
     */
    object Float extends CubicCurve2D with Serializable {
         ...
         */
        @stub
        def apply(x1: Float, y1: Float, ctrlx1: Float, ctrly1: Float, ctrlx2: Float, ctrly2: Float, x2: Float, y2: Float) = ???
