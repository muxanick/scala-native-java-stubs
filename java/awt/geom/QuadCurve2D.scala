...
object QuadCurve2D {
     ...
     *  double coordinates.
     */
    object Double extends QuadCurve2D with Serializable {
         ...
         */
        @stub
        def apply(x1: Double, y1: Double, ctrlx: Double, ctrly: Double, x2: Double, y2: Double) = ???
     ...
     *  float coordinates.
     */
    object Float extends QuadCurve2D with Serializable {
         ...
         */
        @stub
        def apply(x1: Float, y1: Float, ctrlx: Float, ctrly: Float, x2: Float, y2: Float) = ???
