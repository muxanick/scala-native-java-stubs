...
final class DateTimeFormatter extends Object {
    ...
    @stub
    def parse[T](text: CharSequence, query: TemporalQuery[T]): T = ???
...
object DateTimeFormatter {
     ...
     */
    @stub
    val ISO_LOCAL_DATE: DateTimeFormatter = ???

    /** The ISO date-time formatter that formats or parses a date-time without
     *  an offset, such as '2011-12-03T10:15:30'.
     */
    @stub
    val ISO_LOCAL_DATE_TIME: DateTimeFormatter = ???

    /** The ISO time formatter that formats or parses a time without an
     *  offset, such as '10:15' or '10:15:30'.
     */
    @stub
    val ISO_LOCAL_TIME: DateTimeFormatter = ???
     ...
     */
    @stub
    val ISO_WEEK_DATE: DateTimeFormatter = ???
