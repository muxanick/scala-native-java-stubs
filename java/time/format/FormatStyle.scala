...
object FormatStyle {
    ...
    final val FULL: FormatStyle = new FormatStyle("FULL", 0)

    /** Long text style, with lots of detail. */
    final val LONG: FormatStyle = new FormatStyle("LONG", 1)

    /** Medium text style, with some detail. */
    final val MEDIUM: FormatStyle = new FormatStyle("MEDIUM", 2)

    /** Short text style, typically numeric. */
    final val SHORT: FormatStyle = new FormatStyle("SHORT", 3)
